classdef RelatedGeneAnalysisResults
    ...
    methods
        ...
        function [sourceSimGeneTableList,targetSimGeneTableList] = makeTopGeneInformationTables(obj,DimPI)
            arguments(Input)
                obj RelatedGeneAnalysisResults
        ...
        function [t] = tiledImage3DMostCorrelatedGenes(obj,brainSpace3D,brainInfo,DimShow,options)
            ...
            for dpi = 1:DimShow
                ...
                climVec = [-max(abs(regionalGeneExpressionVector)),max(abs(regionalGeneExpressionVector))];
